...
String apiKey = "VKIY3FAJH0SYATC5";
const char* ssid = "POCO M3";  // Enter your WiFi Network's SSID
const char* pass = "varshamohana";  // Enter your WiFi Network's Password
...
void setup() 
{
  ...
  lcd.backlight();
  lcd.setCursor(0, 0);
  lcd.print(" ERTS PROJECT BY");
  lcd.setCursor(0, 1);
  lcd.print("ARUN & ARIKARAN");
  delay(2000);
  lcd.clear();
